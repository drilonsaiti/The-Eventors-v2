                ...
                child: Scaffold(
                    ...
                    body: FutureBuilder(
                      ...
                      builder: (context, AsyncSnapshot<Events?> snapshot) {
                        ...
                        check = context.read<MyActivityProvider>().checkGoingBt;
                                                              ...
                                                              itemBuilder:
                                                                  (context) => [
                                                                        ...
                                                                        PopupMenuItem(
                                                                            ...
                                                                            child:
                                                                                ListTile(leading: Icon(Icons.delete, color: Colors.redAccent), title: Text("Delete"))),
                                                                      ],
                                                              child: Container(
                                                                height: 48,
                                                                width: 38,
